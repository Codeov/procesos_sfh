...
fecha_ini= (datetime.datetime.strftime(datetime.datetime.now()-pd.DateOffset(days=1),'%Y-%m-%d'))
print(fecha_ini)
fecha_fin=(datetime.datetime.strftime(datetime.datetime.now()-pd.DateOffset(days=1),'%Y-%m-%d'))
print(fecha_fin)
