...
from irs_locales   where 
 loc_activo='S'
and cad_numero in (4,8,5,2,13,12,10) --3
and loc_numero <5000
order by 1
"""
...
def ins_scm_tmp_ticket_recaudaciones_ct2(fecha_format_ini_1,sql_stg,ora):
        fecha_format_ini_f=datetime.datetime.strftime(fecha_format_ini_1,'%Y%m%d')
        ls_recaudaciones=request_recaudaciones_ct2(fecha_format_ini_f,ora)
        if ls_recaudaciones !=None:
          sql_stg.query_insert_tupla("insert into scm_tmp_ticket_recaudaciones_ct2 values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",ls_recaudaciones)
          sql_stg.commit()
...
while fecha_format_ini_1<=fecha_format_fin_1:
    #ins_scm_tmp_ticket_recaudaciones_ct2(fecha_format_ini_1,sql_stg,ora)
