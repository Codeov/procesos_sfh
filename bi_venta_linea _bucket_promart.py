...
usuario= "SCT2CHP"
contraseña= "b4s1l34hp"
ip_server_name= "10.20.11.86/HPCT02"
...
try:
    ...
    project="sistemas-bi"
    dataset="SPSA"
    table_cab="tmp_vta_linea_cab"
    table_det="tmp_vta_linea_det"
    #obj_bq.clear_table(project,dataset,table_cab)
    #obj_bq.clear_table(project,dataset,table_det)
    obj_bq.exec_query_sin_param("truncate table `sistemas-bi.SPSA.tmp_vta_linea_cab`;truncate table `sistemas-bi.SPSA.tmp_vta_linea_det`")
    ...
    if df_cab_acum.empty == False and df_det_acum.empty == False:
        ...
        obj_bq.exec_query_sin_param("call `sistemas-bi.SPSA.ins_fact_online_sales_act` ()")
        print("SP `sistemas-bi.SPSA.ins_fact_online_sales_act` () procesado")
