...
# Función para obtener un rango de filas usando ROWNUM, creando una conexión y cursor únicos por hilo
def fetch_data_chunk(start_row, end_row):
    # Crear una conexión y cursor únicos por hilo
    ...
    try:
        ...
        # Cerrar el cursor y la conexión del hilo
        cursor.close()
        obj_ora.cerrar()
...
try:
    ...
    for start_row in range(0, 20000000, batch_size):  # Asumiendo 20 millones de filas
